...
<head>
    ...
    <!--加入think分页样式-->
    <link rel="stylesheet" type="text/css" href="/Public/css/thinkpage.css" />
    <!-- font CSS -->
    ...
    <!--webfonts-->
    <link rel="stylesheet" type="text/css" href="/Public/css/fonts.useso.com.css" />
    <!--//webfonts-->
    <!--animate-->
...
<body class="cbp-spmenu-push">
    ...
    <div class="header-left">
        ...
        <div class="logo">
            <a href="index.html">
                <ul>
                    <li><img src="/Public/images/logo1.png" alt="" /></li>
                    <li><h1>Baxster</h1></li>
                ...
                <div class="tables">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <th>No.</th>
                            <th>Code</th>
                            <th id="date" style="cursor:pointer;color:#67D3E0;"><span>Date&nbsp;</span><span><?php if(ACTION_NAME== 'Date'): if($_GET['desc']== 1): ?>↓<?php else: ?>↑<?php endif; endif; ?></span></th>
                            <th>Name</th>
                            <th>Industry</th>
                            <th>Close</th>
                            <th id="p_change" style="cursor:pointer;color:#67D3E0;"><span>P_change&nbsp;</span><span><?php if(ACTION_NAME== 'P_change'): if($_GET['desc']== 1): ?>↓<?php else: ?>↑<?php endif; endif; ?></span></th>
                            <th id="v2ma20" style="cursor:pointer;color:#67D3E0;"><span>V2ma20&nbsp;</span><span><?php if(ACTION_NAME== 'V2ma20'): if($_GET['desc']== 1): ?>↓<?php else: ?>↑<?php endif; endif; ?></span></th>
                            <th id="vma20_2_max" style="cursor:pointer;color:#67D3E0;"><span>Vma20_2_max&nbsp;</span><span><?php if(ACTION_NAME== 'Vma20_2_max'): if($_GET['desc']== 1): ?>↓<?php else: ?>↑<?php endif; endif; ?></span></th>
                            <th id="turnover" style="cursor:pointer;color:#67D3E0;"><span>Turnover&nbsp;</span><span><?php if(ACTION_NAME== 'Turnover'): if($_GET['desc']== 1): ?>↓<?php else: ?>↑<?php endif; endif; ?></span></th>
                            <th>TimeToMarket</th>
                            <th id="count" style="cursor:pointer;color:#67D3E0;"><span>Count&nbsp;</span><span><?php if(ACTION_NAME== 'Count'): if($_GET['desc']== 1): ?>↓<?php else: ?>↑<?php endif; endif; ?></span></th>
                            <th id="yield_rate" style="cursor:pointer;color:#67D3E0;"><span>Yield_rate&nbsp;</span><span><?php if(ACTION_NAME== 'index'): ?>↓<?php elseif(ACTION_NAME== 'Yield_rate'): if($_GET['desc']== 1): ?>↓<?php else: ?>↑<?php endif; endif; ?></span></th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                <td><label><input name="choose" type="checkbox" value="<?php echo ($vo["code"]); ?>" />&nbsp;&nbsp;删除</label></td>
                                <td><?php echo ($key+1); ?></td>
                                <td id="stock_code"><?php echo ($vo["code"]); ?></td>
                                <td><?php echo ($vo["date"]); ?></td>
                                <td><?php echo ($vo["name"]); ?></td>
                                <td><?php echo ($vo["industry"]); ?></td>
                                <td><?php echo ($vo["close"]); ?></td>
                                <td><?php echo ($vo["p_change"]); ?></td>
                                <td><?php echo ($vo["v2ma20"]); ?></td>
                                <td><?php echo ($vo["vma20_2_max"]); ?></td>
                                <td><?php echo ($vo["turnover"]); ?></td>
                                <td><?php echo (format_date($vo["timetomarket"])); ?></td>
                                <td><?php echo ($vo["count"]); ?></td>
                                <td><?php echo ($vo["yield_rate"]); ?></td>
                            </tr><?php endforeach; endif; ?>
                        </tbody>
                    </table>
                    <input id="manual" type="button" value="   删 除   " style="float:left;"/><div class="manu" style="float:right;"><?php echo ($page); ?></div><div style="clear: both;"></div>
                    <script type="text/javascript">
                        $(function() {
                            $('.tables th[style]').click(function() {
                                ...
                                if(sort == '' || sort == '↑') {
                                    window.location.href = "<?php echo U('Index/"+column+"?desc=1');?>";
                                } else {
                                    window.location.href = "<?php echo U('Index/"+column+"?desc=0');?>";
                                }
                            });
                            ...
                            $('#manual').click(function() {
                                ...
                                window.location.href = "<?php echo U('Index/delete');?>?items="+chooseStr;
                            });
                        });
                    </script>
                </div>
    ...
    <script type="text/javascript" src="/Public/js/dev-loaders.js"></script>
    <script type="text/javascript" src="/Public/js/dev-layout-default.js"></script>
    <script type="text/javascript" src="/Public/js/jquery.marquee.js"></script>
    <link rel="stylesheet" type="text/css" href="/Public/css/bootstrap.min.css" />

    <script type="text/javascript" src="/Public/js/jquery.jqcandlestick.min.js"></script>
    <link rel="stylesheet" type="text/css" href="/Public/css/jqcandlestick.css" />
